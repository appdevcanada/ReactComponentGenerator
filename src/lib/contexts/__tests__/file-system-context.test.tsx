...
// Tool call tests
test("handles file_editor create command", () => {
...
test("handles file_editor create command with error", () => {
...
test("handles file_editor str_replace command", () => {
...
test("handles file_editor str_replace command with error", () => {
...
test("handles file_editor insert command", () => {
...
test("handles file_editor insert command with error", () => {
